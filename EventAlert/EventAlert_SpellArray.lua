...
----------------------------------- 職業主要提醒區 -----------------------------------
	...
	-- DEBUG		
	--	if EA_Items[EA_CLASS_WARLOCK][28189] == nil then EA_Items[EA_CLASS_WARLOCK][28189] = true end;
	--	if EA_Items[EA_CLASS_WARLOCK][5697] == nil then EA_Items[EA_CLASS_WARLOCK][5697] = true end;
	-- Backdraft
