...
function EventAlert_Icon_Options_Frame_PaintAlertFrame()
	if EA_Anchor_Frame1 ~= nil then
		if EA_Anchor_Frame1:IsVisible() then
			local xOffset = 80 + EA_Position.xOffset;
			...
			EA_Anchor_Frame4:ClearAllPoints();
	    		EA_Anchor_Frame4:SetPoint("CENTER", EA_Anchor_Frame3, xOffset, yOffset);
			...
			if (EA_Config.ShowName == true) then
				...
				EA_Anchor_Frame4_Name:SetText(EA_XICON_SELF_DEBUFF.."(4)");
				EA_Anchor_Frame5_Name:SetText(EA_XICON_TARGET_DEBUFF.."(1)");
				EA_Anchor_Frame6_Name:SetText(EA_XICON_TARGET_DEBUFF.."(2)");
			else
			...
			if (EA_Config.ShowTimer == true) then
				if (EA_Config.ChangeTimer == true) then
					...
					EA_Anchor_Frame6_Timer:ClearAllPoints();
					EA_Anchor_Frame6_Timer:SetPoint("CENTER", 0, 0);
				else
					-- timerFontSize = 18;
					EA_Anchor_Frame1_Timer:ClearAllPoints();
					...
					EA_Anchor_Frame6_Timer:ClearAllPoints();
					EA_Anchor_Frame6_Timer:SetPoint("TOP", 0, 20);
				end
				...
				EA_Anchor_Frame6_Timer:SetFont("Fonts\\\FRIZQT__.TTF", EA_Config.TimerFontSize, "OUTLINE");
				EA_Anchor_Frame6_Timer:SetText(0);
			else
				...
				EA_Anchor_Frame6_Timer:SetText("");
			end
			...
			EA_Anchor_Frame6:SetWidth(EA_Config.IconSize);
			EA_Anchor_Frame6:SetHeight(EA_Config.IconSize);
			EA_Anchor_Frame1:Show();
			EA_Anchor_Frame2:Show();
			EA_Anchor_Frame3:Show();
			EA_Anchor_Frame4:Show();
			EA_Anchor_Frame5:Show();
			EA_Anchor_Frame6:Show();
		end
	end
end
