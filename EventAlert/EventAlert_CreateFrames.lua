function EventAlert_CreateFrames()
	...
	CreateFrames_CreateAnchorFrame("EA_Anchor_Frame4", false);
	CreateFrames_CreateAnchorFrame("EA_Anchor_Frame5", true);
	CreateFrames_CreateAnchorFrame("EA_Anchor_Frame6", true);
	EA_Anchor_Frame1:SetPoint(EA_Position.Anchor, UIParent, EA_Position.xLoc, EA_Position.yLoc);
        EA_Anchor_Frame2:SetPoint("CENTER", EA_Anchor_Frame1, 80+EA_Position.xOffset, 0+EA_Position.yOffset);
        EA_Anchor_Frame3:SetPoint("CENTER", EA_Anchor_Frame2, 80+EA_Position.xOffset, 0+EA_Position.yOffset);
	EA_Anchor_Frame4:SetPoint("CENTER", EA_Anchor_Frame3, 80+EA_Position.xOffset, 0+EA_Position.yOffset);

        EA_Anchor_Frame5:SetPoint("CENTER", EA_Anchor_Frame1, -1 * (80+EA_Position.xOffset), -1 * (0+EA_Position.yOffset));
        -- EA_Anchor_Frame4:SetPoint(EA_Position.TarAnchor, UIParent, -1 * (100+EA_Position.xOffset), -1 * (0+EA_Position.yOffset));
        EA_Anchor_Frame6:SetPoint("CENTER", EA_Anchor_Frame5, -1 * (80+EA_Position.xOffset), -1 * (0+EA_Position.yOffset));
